      ...
      <div className="mb-6">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex space-x-3">
            ...
            <span className={`px-4 py-2 rounded-full font-bold text-white capitalize
              ${pago.estatus === 'pagado' ? 'bg-green-500' : 
                pago.estatus === 'atrasado' ? 'bg-red-500' : 'bg-yellow-500'}`}>
              {pago.estatus}
            </span>
          </div>
        </div>
          ...
          <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
             <div className="sm:col-span-1">
              ...
              <dd className="mt-1 text-sm text-indigo-600 hover:text-indigo-800">
                <Link href={`/ventas/${typeof pago.venta_id === 'object' ? pago.venta_id.id : pago.venta_id}`}>
                   {typeof pago.venta_id === 'object' ? String(pago.venta_id.id).substring(0, 8) : pago.venta_id}
                </Link>
              </dd>
            </div>
            <div className="sm:col-span-1">
              ...
              <dd className="mt-1 text-sm text-gray-900">
                {typeof pago.venta_id === 'object' && typeof pago.venta_id.cliente_id === 'object'
                  ? `${pago.venta_id.cliente_id.nombre} ${pago.venta_id.cliente_id.apellido_paterno}`
                  : 'N/A'}
              </dd>
            </div>
            <div className="sm:col-span-1">
              ...
              <dd className="mt-1 text-sm text-gray-900">
                 {typeof pago.venta_id === 'object' && typeof pago.venta_id.lote_id === 'object'
                  ? pago.venta_id.lote_id.identificador
                  : 'N/A'}
              </dd>
            </div>
          </dl>
