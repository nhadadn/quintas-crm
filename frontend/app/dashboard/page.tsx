  ...
  if (status === 'loading' || loading) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold text-text-primary tracking-tight">Executive View</h1>
  ...
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-md border border-border bg-card p-4 shadow-card">
          <div className="mb-3 text-xl font-semibold text-text-primary tracking-tight">Alertas críticas</div>
