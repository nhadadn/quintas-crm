...
async function fixFields() {
  ...
  try {
    ...
    const fieldsToInsert = [
      // LOTES
      { collection: 'lotes', field: 'estatus', interface: 'select-dropdown', options: JSON.stringify({ choices: [{ text: 'Disponible', value: 'disponible' }, { text: 'Apartado', value: 'apartado' }, { text: 'Vendido', value: 'vendido' }] }) },
