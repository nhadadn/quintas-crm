...
async function inspect() {
  // Login
   ...
   } catch(e) { console.error('Error fetching client sample:', e); }
  ...
  for (const col of collections) {
    try {
      ...
      if (col === 'clientes') console.log(`  - vendedor_id exists?`, fields.includes('vendedor_id'));
      if (col === 'pagos') console.log(`  - venta_id exists?`, fields.includes('venta_id'));
      if (col === 'comisiones') console.log(`  - vendedor_id exists?`, fields.includes('vendedor_id'));
    } catch (e) {
