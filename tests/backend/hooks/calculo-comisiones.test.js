...
describe('Hook: Cálculo de Comisiones', () => {
  ...
  test('should calculate commissions based on vendor rate', async () => {
    ...
    itemsServiceMock.readOne
      ...
      .mockResolvedValueOnce({ // Vendedor (called inside generarComisiones)
        id: 10,
    ...
    const comisionesCall = calls.find(call => call[0] && call[0][0] && call[0][0].tipo_comision && call[0][0].tipo_comision.includes('Comisión'));
