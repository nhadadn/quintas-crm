...
-   Detección de hardcoding y código no esencial y/u obsoleto.
...
-   Fases 1-3: Base técnica establecida (mapa SVG conectado con directus, base de datos CRM, módulos de ventas y pagos)
...
-   Leer el PROMPT MAESTRO de la fase auditada (PROMPTS\_MAE\_FASES\_4\_5\_6.md)
...
-   Especificaciones: Ver archivo PROMPTS\_MAE\_FASES\_4\_5\_6.md

Tarea: Ejecuta el proceso de auditoría completo siguiendo el template en PROMPT\_AUDITORIA\_VALIDACION\_FASES.md
...
-   Archivo: AUDITORIA\_FASE\_4\_DASHBOARDS\_REPORTES.md
